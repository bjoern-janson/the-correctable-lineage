...
## A synthesis of recursively correctable adaptation
...
- toy simulations and benchmark designs;
- implementation attempts and discovered defects;
...
\text{broad concept}
\rightarrow
\text{causally distinct components}
\rightarrow
\text{separate tests}
\rightarrow
\text{more local correction}.
\]
